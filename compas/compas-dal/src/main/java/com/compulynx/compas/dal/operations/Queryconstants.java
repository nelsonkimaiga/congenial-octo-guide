...
//	
	...
	public static String getProducts = "SELECT p.ID,product_code,product_name,start_date,end_date,fund, type,p.Active,p.Created_By,p.Created_On, p.Insurance_Code, "
			...
			+ "FROM productMaster p where  org_id=? and product_name != 'LIAISON GROUP STAFF'";
	// voucher
	...
	public static String getAllJudiciaryMembers = "SELECT \r\n" + 
			"    emp_ref_key,\r\n" + 
			"    emp_fullname,\r\n" + 
			"    emp_dob,\r\n" + 
			"    em.active,\r\n" + 
			"    (CASE WHEN member_type = 'D' THEN 'DEPENDANT' WHEN member_type = 'P' then 'PRINCIPAL' ELSE member_type END) AS member_type,\r\n" + 
			"    product_name\r\n" + 
			"FROM\r\n" + 
			"    emp_mst em\r\n" + 
			"        INNER JOIN\r\n" + 
			"    productmaster pm ON em.product_id = pm.id\r\n" + 
			"WHERE\r\n" + 
			"    product_name != 'LIAISON GROUP STAFF'";
