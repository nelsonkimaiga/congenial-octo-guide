 ...
 */
'use strict';
angular.module('app.nbhdashboard', []).controller("nbhdashBoardCtrl", ["$scope", "$filter", "$rootScope", "dashBoardSvc","blockUI", "logger" ,"$location", function ($scope, $filter, $rootScope,dashBoardSvc, blockUI, logger, $location) {
	var init;
	var percentage=0;
	$scope.hide=false;
	$scope.tempCountList = [];
