 ...
 */
'use strict';
angular.module('app.akuhrptprovidertrans', []).controller("akuhrptProviderTransCtrl", ["$scope", "$filter", "rptProviderTransSvc","organizationSvc","merchantSvc", "$rptProviderTransValid", "$rootScope", "blockUI", "logger", "$location","$http","$window", function ($scope, $filter, rptProviderTransSvc,organizationSvc,merchantSvc, $rptProviderTransValid, $rootScope, blockUI, logger, $location,$http,$window) {
    ...
    $scope.exportReport=function(type)    {
        ...
        if(FromDt == null){
		   ...
		   return false;
            ...
            $scope.url = '/compas/reports?type=PT&FrDt=' +FromDt+'&ToDt='+ToDt+'&ProviderId='+providerId+'&orgId='+orgId+'&eType='+type;
        }
...
$scope.loadTransactions=function(){
  ...
  rptProviderTransSvc.GetProviderWiseDetailedTxn(gate).success(function (response) {
...
//$scope.loadTransactions();
    ...
    shpProviderTrans.GetProviderWiseDetailedTxn = function (gate) {
        return $http({
            url: '/compas/rest/transaction/gtProviderWiseTxnDetail/',
            method: 'POST',
