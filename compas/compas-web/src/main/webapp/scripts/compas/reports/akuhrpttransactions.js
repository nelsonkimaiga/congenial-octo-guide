...
//	
    ...
    $scope.exportReport=function(type)    {
        ...
        if(FromDt == null){
            ...
            $scope.url = '/compas/reports?type=AKT&FrDt=' +FromDt+'&ToDt='+ToDt+'&orgId='+orgId+'&eType='+type;
            $location.path('/akuhreports/transaction');
        }
	...
	$scope.loadTransactions = function () {
		...
		claimgate.fromDate = $scope.fromDt;
		claimgate.toDate = $scope.toDt;
		claimgate.orgId = $scope.orgSelect;
		//     gate.merchantId = $scope.merchantSelect;
		//     gate.productId = $scope.productSelect;
		voucherSvc.GetAllDetailedAkuhTxn(claimgate).success(function (response) {
	...
	$scope.loadAmpuntDetail = function () {
		voucherSvc.GetCurrentDetailedAKUHTxn().success(function (response) {
