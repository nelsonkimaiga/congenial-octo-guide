 ...
 */
'use strict';
angular.module('app.memberstatement', []).controller("memStatementCtrl", ["$scope", "$filter", "memStatementSvc","organizationSvc", "$memStatementValid", "$rootScope", "blockUI", "logger", "$location","$http","$window", function ($scope, $filter, memStatementSvc,organizationSvc, $memStatementValid, $rootScope, blockUI, logger, $location,$http,$window) {
	$scope.mem=[];
	...
	$scope.loadTransactions=function(){
	  ...
	  memStatementSvc.GetMemberDetailedTxn(gate).success(function (response) {
